...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/galaxy/spinner.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        isMobile ? (React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$K, { width: "24px", color: "textSubtle" })))) : (React.createElement(React.Fragment, null)),
...
var Accordion$1 = function (_a) {
    ...
    return (React.createElement(Container$5, null,
        React.createElement(TopMenuEntry, { onClick: handleClick, className: className },
            icon,
            React.createElement(LinkLabel$1, { isPushed: isPushed }, label),
            isOpen ? React.createElement(Icon$8, null) : React.createElement(Icon$7, null)),
        React.createElement(AccordionContent$1, { isOpen: activeAccordion === label, isPushed: isPushed, maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT }, children)));
};
...
var TopMenu = function (_a) {
    ...
    return (React.createElement(Container$6, { style: isMobile ? { display: 'none' } : { display: 'flex' } }, links.map(function (entry) {
        ...
        var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
        if (entry.items) {
            return (React.createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass, activeAccordion: showAccordion, setActiveAccordion: setShowAccordion }, isPushed &&
